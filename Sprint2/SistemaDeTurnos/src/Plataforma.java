...
public class Plataforma {
    ...
    public static Secretaria login(){
        ...
        while(opcion.equals("s")){
            ...
            if((cuentasSecretaria.containsKey(contrasena)) && (cuentasSecretaria.get(contrasena).getEmail().equals(email))) {
    ...
    public static List<Turno> verProximosTurnos(Medico m) {
    ...
    public static void menuSecretaria(Secretaria s){
        ...
        while (!salir) {
            ...
            System.out.println("3. Mostrar turnos de medicos");
    ...
    public static void seleccionarTurno(String nombreCompleto){
        ...
        if(linea.equals("s")){
            ...
            Secretaria s = null; Medico m=null;
            ...
            if(cuentasPaciente.containsKey(dni))
                paciente = cuentasPaciente.get(dni);
            Turno turno = new Turno(paciente, m, d1, h);
            if ((s != null) && (paciente!=null) && (s.addTurno(turno))) {
    ...
    public static void main(String[] args) {
        ...
        //Cuentas de secretarias
        cuentasSecretaria.put(1, s1);  //josefa@gmail.com - Contraseña: 1
        cuentasSecretaria.put(2, s2);  //lorena@gmail.com - Contraseña: 2
        ...
        Turno t1= new Turno(p1, m1, d1, 16);
